                ...
                <div className="row no-gutters h-700">
                    <div className="col-md-6 d-flex flex-column bg-black align-items-center text-white justify-content-center form border blackBorder rounded-4">
                        <div className="inner text-center">
                            ...
                            <NavLink to="/Login" className="btn btn-outline-dark rounderd-pill pb-2 w-50 text-white">Sign in</NavLink>
                        </div>
                    </div>
                    <div className="col-md-6 p-5 d-flex flex-column justify-content-center border whiteBorder rounded-4 cssBox">
                        <div className="inner">
                            ...
                            <form>
                            <div class="mb-3">
                                    <input type="text" class="form-control bg-dark text-white" id="nameInput" placeholder="Name" aria-describedby="NameHelp" />
                                </div>
                                <div class="mb-3">
                                    <input type="email" class="form-control bg-dark text-white" id="emailInput" placeholder="Email" aria-describedby="emailHelp" />
                                </div>
                                <div className="input-group mb-3">
                                    <input type={showPassword ? 'text' : 'password'} class="form-control bg-dark text-white" placeholder="Password" id="passwordInput" />
                                ...
                                <div className="input-group mb-3">
                                    <input type={showPassword ? 'text' : 'password'} class="form-control bg-dark text-white" placeholder="Confirm password" id="confirmPasswordInput" />
                                    <button type="button" className="btn bg-dark text-white" onClick={handlePasswordVisibility}>
                                        <i className={`fa fa-${showPassword ? 'eye-slash' : 'eye'}`} />
                                    </button>
                                </div>
